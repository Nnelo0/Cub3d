...
/*   Updated: 2025/03/19 10:53:32 by lelanglo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move(t_data *data, int sens)
{
	...
	if (sens == 1)
	{
		if (data->map[(int)data->player.y][(int)(data->player.x + data->player.dir_x * (double)SPEED)] == '0')
			data->player.x += data->player.dir_x * (double)SPEED;
		if (data->map[(int)(data->player.y + data->player.dir_y * (double)SPEED)][(int)data->player.x] == '0')
...
void	left_right(t_data *data, int sens)
{
	...
	if (sens == 1)
	{
		if (data->map[(int)data->player.y][(int)(data->player.x + data->player.plane_x * (double)SPEED)] == '0')
			data->player.x += data->player.plane_x * (double)SPEED * sens;
		if (data->map[(int)(data->player.y + data->player.plane_y * (double)SPEED)][(int)data->player.x] == '0')
